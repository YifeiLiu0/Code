...
# tokenizer = AutoTokenizer.from_pretrained("/storage/user/qin/mimic-iii-clinical-database-1.4/CORe-clinical-outcome-biobert-v1")
# model = AutoModel.from_pretrained("/storage/user/qin/mimic-iii-clinical-database-1.4/CORe-clinical-outcome-biobert-v1")
...
def doc_classification(task_config,
    ...
    if do_eval:
        ...
        model = ExtendedAdaptiveModel.load(str(model_dir), device)
        ...
        if print_preds:
            ...
            utils.save_preds(results, save_dir=model_dir, multilabel=task_config["multilabel"])
...
# if __name__ == '__main__':
#     fire.Fire(lambda: doc_classification(
#         task_config="/usr/stud/qin/Desktop/clinical-outcome-prediction/experiments/configs/config_mp_share.yaml",
#         model_name_or_path="/storage/user/qin/mimic-iii-clinical-database-1.4/CORe-clinical-outcome-biobert-v1",
#         cache_dir="/storage/user/qin/mimic-iii-clinical-database-1.4/cache_dir_share"
#     ))
...
#     fire.Fire(lambda: doc_classification(
#         task_config="/usr/stud/qin/Desktop/clinical-outcome-prediction/experiments/configs/config_mp_share.yaml",
#         model_name_or_path="/storage/user/qin/mimic-iii-clinical-database-1.4/output_dir_mp_share/mp_0/exp_496042/final_model",
#         cache_dir="/storage/user/qin/mimic-iii-clinical-database-1.4/cache_dir_share"
#     ))
...
if __name__ == '__main__':
    fire.Fire(lambda: doc_classification(
        task_config="/usr/stud/qin/Desktop/clinical-outcome-prediction/experiments/configs/config_mp_share.yaml",
        model_name_or_path="/storage/user/qin/mimic-iii-clinical-database-1.4/output_dir_mp_share/mp_0/exp_594634/final_model",
        cache_dir="/storage/user/qin/mimic-iii-clinical-database-1.4/cache_dir_share"
    ))
